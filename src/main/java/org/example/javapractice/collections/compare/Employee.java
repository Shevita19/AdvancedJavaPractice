...
public class Employee implements Comparable <Employee> {
    ...
    public int compareTo(Employee o) {       //Comparable is an interface and has compareTo method
     ...
     // return (this.empId - o.empId);  // will display data in ascending order
           ...
           int nameCompare = this.empName.compareTo(o.empName);
            if (nameCompare != 0) {
                return nameCompare;
            } else {
    ...
    public static void main(String[] args) {
        ...
        empRecord.add(new Employee("shweta", 10, "33333"));

        empRecord.add(new Employee("ashutosh", 40, "22222"));

        empRecord.add(new Employee("shubham", 6, "2222"));
